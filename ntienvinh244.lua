...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì TienVinhHub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : Ngtienvinh <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Tienvinh Hub", HidePremium = false, IntroText = "TienVinhHub Library", SaveConfig = true, ConfigFolder = "TienVinh Hub"})
...
OrionLib:MakeNotification({
	Name = "TienVinh Hub",
	Content = "NtienVinh Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By nguyentienvinh")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] TienVinh Hub is The Best")
W:AddLabel("[+] I Not Skidder!")
W:AddLabel("[+] I Welcome to TienVinh Hub!!!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "TienVinh Hub(Noitification)",
